...
upload_class = Upload(config)
data = {"video_title":script.video_title, "description":script.description, "tags":script.tags}
video_path = "artifacts/videos/260909080828.mp4" #to be made dynamic
language = "English"
print(upload_class.upload(data,video_path,language))